...
public class Robot implements Picker, Bidder {
	...
	public boolean isAvailable(Pick pick) {
		synchronized (this.currentPicks) {
	 ...
	 *
	 * @param currentFacingDirection
	 *            The new direction the robot is facing.
	 */
	 ...
	 *
	 * @param job
	 *            Picks which belong to this job will be dropped.
	 * @return True if any pick was unassigned.
	 */
